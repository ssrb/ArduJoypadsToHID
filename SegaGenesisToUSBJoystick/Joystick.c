...
void SegaGenesisJoypad_Init() {

	pinMode(SEGA_GENESIS_JOY_UP, INPUT);
	pinMode(SEGA_GENESIS_JOY_DOWN, INPUT);
	pinMode(SEGA_GENESIS_JOY_LEFT, INPUT);
	pinMode(SEGA_GENESIS_JOY_RIGHT, INPUT);
	pinMode(SEGA_GENESIS_JOY_B, INPUT);
	pinMode(SEGA_GENESIS_JOY_C, INPUT);

	pinMode(SEGA_GENESIS_JOY_SELECT, OUTPUT);
}